...
export const allHeroPowers = [
    ...
    },
    {
        ...
        name: 'Boarding Party',
        text: 'Choose a friendly DWG faction ship. you may exchange it with one of your opponents Faction ships or submarines of equal or lesser cost from the same zone',
        cpCost: 1
    },
    {
        faction: FACTIONS.OW,
